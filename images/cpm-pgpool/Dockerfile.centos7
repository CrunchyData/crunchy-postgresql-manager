...
RUN yum install -y epel-release rsyslog procps-ng postgresql94 postgresql94-contrib pgpool-II-94 libxslt which unzip openssh-clients hostname && yum clean all -y
